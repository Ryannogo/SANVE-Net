...
model_path = op.join(ROOT_path, 'results', 'train_D')
output_path = op.join(ROOT_path, 'predict_N64D')
...
with torch.no_grad():
    for idx in range(len(demo_dataset)):
        ...
        #/home0/ryan/NerVE-main/NerVE64Dataset/00000003/pc_obj.pkl
        res = {}
        ...
        curve_outfile = os.path.join(curve_outputpath, 'pred_FF_pwl.pkl')
        nerve_outfile = os.path.join(curve_outputpath, 'pred_FF.pkl')
