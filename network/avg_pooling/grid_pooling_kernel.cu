    ...
    int k)
{
    ...
    AT_DISPATCH_FLOATING_TYPES(point_feat.type(), "avg_pooling_forward_cu",//此处修改point_feat.type()为point_feat.scalar_type()//
                               ([&]
    ...
    torch::Tensor pidx_counts)
{
    ...
    AT_DISPATCH_FLOATING_TYPES(grad_output.scalar_type(), "avg_pooling_backward_cu",//此处修改point_feat.type()为point_feat.scalar_type()//
                               ([&]
